...
This document is a data analysis report for a class. The code for data cleaning and analysis can all be found in https://github.com/cfss-hmwks/hw06-yuhangli02.git  
